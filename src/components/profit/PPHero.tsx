...
const heroImage = "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&q=80&w=1600";
const heroImageSrcSet = "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&q=80&w=800 800w, https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&q=80&w=1600 1600w";
      ...
      <div className="relative mx-auto max-w-[1280px] px-6 sm:px-10 md:px-16">
        <div className="grid lg:grid-cols-12 items-center">
          <div className="lg:col-span-7 py-16 lg:py-32">
            ...
            >
              Trust transfers from the person who{" "}
              <span className="text-brand-blue ppx-italic">sent them</span>.
            </h1>

            <p className="mt-7 max-w-[520px] text-[15px] md:text-[16px] leading-[1.65] text-[hsl(var(--slate-700))]">
              Profit Partners™ is the working alliance of complementary business owners who actively recommend each other to the families they already serve.
            </p>
