      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8 md:px-10 py-16 md:py-32 grid md:grid-cols-[55fr_45fr] gap-12 md:gap-20 items-start">
        <div>
          ...
          <p className="mt-6 max-w-[540px] text-[17px] md:text-[19px] leading-relaxed text-[hsl(var(--slate-700))]">
            Category exclusivity means one partner per industry in the Phoenix market. The result is a room built to send each other business instead of compete for the same customer. Members typically know each other a quarter in and have moved at least one referral by month four.
          </p>
