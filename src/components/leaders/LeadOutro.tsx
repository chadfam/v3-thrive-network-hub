  ...
  return (
    <section className="bg-[#F8F9FB]">
      ...
      <div className="relative mx-auto max-w-[1080px] px-6 sm:px-10 md:px-16 pt-12 pb-24 md:pt-16 md:pb-36 text-center">
        ...
        >
          Build a practice that <span className="text-brand-blue ppx-italic">builds your community</span>.
        </h2>

        <p className="mt-8 mx-auto max-w-[680px] text-[17px] md:text-[19px] leading-[1.65] text-[hsl(var(--slate-700))]">
          You weren't meant to build alone, and neither were the families you serve. Step into the role your community already gives you, with a platform underneath that handles the rest.
        </p>
