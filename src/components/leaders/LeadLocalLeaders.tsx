      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 md:px-10 py-16 md:py-32 grid md:grid-cols-12 gap-10 md:gap-16 md:items-start">
        <div className="md:col-span-5">
          ...
          <p className="mt-4 text-[17px] leading-relaxed text-[hsl(var(--slate-700))] max-w-[440px]">
            Each Local Leader holds one industry in their area. When that category is claimed, it's claimed. You become the recognized connector in your category, featured at FAM Central events near you, and you earn when families in your network make decisions through your introductions.
          </p>
