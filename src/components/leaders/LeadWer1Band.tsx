  ...
  return (
    <section style={{ backgroundColor: "#0B1F3F" }}>
      <div className="mx-auto max-w-[1280px] px-6 sm:px-10 md:px-16 py-20 md:py-32 text-center text-white">
        ...
        >
          A proven platform. <span className="ppx-italic" style={{ color: "#FBBF24" }}>Built for leaders</span>.
        </h2>

        <p className="mt-8 mx-auto max-w-[680px] text-[17px] md:text-[19px] leading-[1.65] text-white/85">
          Every introduction inside the network is attributed to its source and paid automatically through WER1. Earning isn't a side feature. It's how the whole community is wired.
        </p>
