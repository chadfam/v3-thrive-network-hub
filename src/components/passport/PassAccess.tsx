const cards = [
  {
    ...
    body: "Profit Partners members receive Passport access as part of their membership. The Passport sits inside a broader alliance focused on referrals, joint ventures, and operating support.",
    cta: "Explore Profit Partners →",
    href: "/profit-partners",
  },
  {
    label: "Option two",
    heading: "Standalone application.",
    body: "For owners and executives who want Passport access without joining the full Profit Partners alliance. Membership is annual. Applications reviewed within five business days.",
      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8 md:px-10 py-16 md:py-32">
        <div className="text-center max-w-[760px] mx-auto">
          ...
          <p className="mt-8 text-[17px] md:text-[19px] leading-relaxed text-[hsl(var(--slate-700))]">
            Through a Profit Partners membership, or through standalone Passport application.
          </p>
        </div>
