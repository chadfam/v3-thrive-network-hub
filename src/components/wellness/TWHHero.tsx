    ...
    <section className="bg-background">
      <div className="mx-auto max-w-[880px] px-6 sm:px-8 md:px-10 pt-16 md:pt-32 pb-16 text-center">
        ...
        <p className="mt-8 mx-auto max-w-[720px] text-[17px] md:text-[21px] text-[hsl(var(--slate-700))] leading-relaxed">
          Team Wellness Hub gives your team real, supplemental wellness benefits. It's set up as a pre-tax benefit (the kind that's been in the tax code for decades).
        </p>
        <p className="mt-5 mx-auto max-w-[720px] text-[17px] md:text-[21px] text-[hsl(var(--slate-700))] leading-relaxed">
          Employees take home more pay. The business saves on payroll taxes. It sits alongside whatever insurance you already offer. A raise for the team, without raising payroll.
        </p>
