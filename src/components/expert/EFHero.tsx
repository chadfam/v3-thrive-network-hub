...
const heroImage =
  "https://images.unsplash.com/photo-1478737270239-2f02b77fc618?auto=format&fit=crop&q=80&w=1600";
const heroImageSrcSet =
  "https://images.unsplash.com/photo-1478737270239-2f02b77fc618?auto=format&fit=crop&q=80&w=800 800w, https://images.unsplash.com/photo-1478737270239-2f02b77fc618?auto=format&fit=crop&q=80&w=1600 1600w";
    ...
    >
      ...
      <div className="lg:hidden">
        <img
          ...
          srcSet={heroImageSrcSet}
          sizes="100vw"
          alt="A speaker recording at a studio microphone in warm light."
        ...
        <div className="grid lg:grid-cols-12 items-center">
          <div className="lg:col-span-7 py-16 lg:py-32">
            ...
            <p className="mt-7 max-w-[520px] text-[15px] md:text-[16px] leading-[1.65] text-[hsl(var(--slate-700))]">
              Expert Faculty is a curated network of trusted experts whose content reaches families across the WEcosystem.
            </p>
