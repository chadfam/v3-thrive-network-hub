const stats = [
  ...
  {
    value: "20",
    label: "Years of relationship-driven growth methodology behind the alliance.",
  },
];
  ...
  return (
    <section style={{ backgroundColor: "#0B1F3F" }}>
      <div className="mx-auto max-w-[1280px] px-6 sm:px-10 md:px-16 py-20 md:py-32 text-center text-white">
        ...
        >
          A proven system, now built into a <span className="ppx-italic" style={{ color: "#FBBF24" }}>working alliance</span>.
        </h2>
