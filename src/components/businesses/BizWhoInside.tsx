    ...
    <section className="bg-background">
      <div className="mx-auto max-w-[760px] px-6 sm:px-8 md:px-10 py-16 md:py-32 text-center">
        ...
        <p className="mt-8 text-[17px] md:text-[19px] leading-relaxed text-[hsl(var(--slate-700))]">
          Most members run businesses between $500K and $50M annually. They're past needing more attention. They're tired of paying for it.
        </p>
        <p className="mt-6 text-[17px] md:text-[19px] leading-relaxed text-[hsl(var(--slate-700))]">
          They show up in person. They make introductions without keeping score. They think about reputation in twenty-year increments.
        </p>
        <p className="mt-6 text-[17px] md:text-[19px] leading-relaxed text-[hsl(var(--slate-700))]">
          The Phoenix chapter has owners in real estate, mortgage, financial advisory, insurance, home services, professional services, construction, automotive, and the trades.
        </p>
        <p className="mt-6 text-[17px] md:text-[19px] leading-relaxed text-[hsl(var(--slate-700))]">
          Category exclusivity is one per industry per market. The room you walk into is built to send each other business, not compete for the same customer.
        </p>
        <p className="mt-6 text-[17px] md:text-[19px] leading-relaxed text-[hsl(var(--slate-700))]">
