...
const offerings: Offering[] = [
  ...
  },
  {
    ...
    benefits: [
      ...
      "Proximity to where capital and deals move",
    ],
    to: "/mastermind-passport",
  },
  {
    name: "Command Central™",
    body: "Your own board of advisors, experts, and service providers we've personally worked with across every front you need.",
    benefits: [
