...
const businesses: Tile[] = [
  ...
  { name: "Mastermind Passport™", desc: "Proximity is power. Walk into the rooms most owners spend years trying to find. The rooms where capital, partnerships, and the right introductions move.", cta: "Learn more →", to: "/mastermind-passport" },
