    ...
    <section className="warm-tint-bg">
      <div className="mx-auto max-w-3xl px-6 sm:px-8 md:px-10 py-14 md:py-20">
        ...
        <p className="mt-6 text-[17px] md:text-[19px] leading-relaxed text-[hsl(var(--slate-700))]">
          We help you turn the families you serve into brand champions who recommend you by name. Referred prospects already know you, like you, and trust you. They close at a far higher rate than anyone who found you through an ad.
        </p>
        <p className="mt-6 text-[17px] md:text-[19px] leading-relaxed text-[hsl(var(--slate-700))]">
          Our network skews toward owners who think in decades, not quarters. The ones who care about their kids, their community, and their reputation in twenty years. People who'd rather earn a recommendation than buy attention. If that's you, you're already in the right room.
        </p>
      </div>
    </section>
  );
