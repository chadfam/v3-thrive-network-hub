...
const points: { lead: string; body: string }[] = [
  {
    ...
    body: "Most companies don't have a referral program. We help you build one, so the people who already love you become brand champions who recommend you by name.",
  },
  {
