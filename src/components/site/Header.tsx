    ...
    <header className="sticky top-0 z-50 bg-background border-b border-slate-ink/10">
      <div className="mx-auto max-w-7xl px-6 sm:px-8 md:px-10 h-16 md:h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link
            to="/apply"
            className="inline-flex items-center justify-center min-h-[44px] px-3.5 sm:px-5 py-2 sm:py-2.5 rounded-md text-[13px] sm:text-[14px] font-medium text-white bg-brand-blue hover:bg-brand-blue-hover transition-colors whitespace-nowrap"
          >
            Join our WEcosystem
          </Link>
          <button
