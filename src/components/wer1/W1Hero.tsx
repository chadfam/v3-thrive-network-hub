  ...
  return (
    <section style={{ backgroundColor: "#0B1F3F" }} className="text-white">
      <div className="mx-auto max-w-[880px] px-6 sm:px-8 md:px-10 pt-24 md:pt-32 pb-20 md:pb-24 text-center">
        ...
        >
          The patented affiliate platform behind the network.
        </h1>
        <p className="mt-8 text-[17px] md:text-[21px] leading-relaxed text-white/90 max-w-[720px] mx-auto">
          WER1 is a patented affiliate and referral platform built on a Waves of Pay model that pays multiple people per transaction. We use it to power every program inside United to Thrive. We also offer it as a promoter platform for individuals and as a white-label engine for partner businesses.
        </p>
