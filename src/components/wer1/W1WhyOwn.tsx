    ...
    <section className="bg-background">
      <div className="mx-auto max-w-[760px] px-6 sm:px-8 md:px-10 py-20 md:py-32 text-center">
        ...
        <div className="mt-8 space-y-6">
          ...
          <p className="text-[17px] md:text-[19px] leading-relaxed text-[hsl(var(--slate-700))]">
            We acquired WER1 specifically so the platform underneath United to Thrive could be built around the principle that the chain is the point. The patent on Waves of Pay is real. The platform is built for it. We can configure it for partner businesses because we own the codebase, not because we're licensing it from someone else. The math works because the math was designed before the platform existed, then the platform was built to deliver it.
          </p>
        </div>
