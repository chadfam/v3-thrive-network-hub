        ...
        <div className="grid md:grid-cols-12 gap-12 md:gap-16 items-start">
          <div className="md:col-span-7">
            ...
            <p className="mt-8 max-w-[540px] text-[17px] md:text-[19px] text-[hsl(var(--slate-700))] leading-relaxed">
              The role is built for people who already do this work informally.
            </p>
            <p className="mt-5 max-w-[540px] text-[17px] md:text-[19px] text-[hsl(var(--slate-700))] leading-relaxed">
              The realtor whose neighbors text her about contractors. The financial advisor whose clients ask for restaurant recommendations. The pediatrician's wife who runs the school auction every year.
            </p>
            <p className="mt-5 max-w-[540px] text-[17px] md:text-[19px] text-[hsl(var(--slate-700))] leading-relaxed">
              You don't need to be a marketer or a salesperson. You need to be the person your community already calls.
            </p>
            <p className="mt-6 max-w-[540px] text-[17px] md:text-[19px] text-[hsl(var(--slate-700))] leading-relaxed">
              We're looking for connectors and community-minded leaders, not affiliate promoters. Selection prioritizes character, presence in the community, and a genuine interest in helping families.
            </p>
            <p className="mt-5 max-w-[540px] text-[17px] md:text-[19px] text-[hsl(var(--slate-700))] leading-relaxed">
              Income is the consequence of the work, not the reason to do it.
            </p>
          </div>
