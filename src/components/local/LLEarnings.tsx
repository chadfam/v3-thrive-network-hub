const cards = [
  ...
  },
  {
    ...
    body: "When you bring another Local Leader, FAM Guide, or member into the network, you earn through the patented Waves of Pay model on their network activity over time.",
  },
];
