...
const Terms = () => (
  <div className="min-h-screen bg-background text-slate-ink">
    <Helmet>
      <title>Terms of Service | United to Thrive</title>
      <meta name="description" content="The agreement between United To Thrive LLC and visitors, members, and partners using the United to Thrive platform and programs." />
    </Helmet>
    <Header />
    <main>
