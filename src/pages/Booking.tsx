      ...
      <div className="relative mx-auto max-w-2xl px-6 sm:px-10 md:px-16 py-20 md:py-28">
        ...
        <article className="mt-10 rounded-2xl overflow-hidden bg-white shadow-[0_24px_60px_-12px_rgba(0,0,0,0.55)]">
          ...
          <div className="p-6 sm:p-8 md:p-10">
            {/*
              GHL calendar embed goes here. Paste the embed code provided by Chad,
              replacing the placeholder block below.
            */}
            <div className="flex min-h-[440px] items-center justify-center rounded-lg border border-dashed border-slate-ink/20 px-6 text-center">
              <p className="text-[15px] text-[hsl(var(--slate-500))]">
