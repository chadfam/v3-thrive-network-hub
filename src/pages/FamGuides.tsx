...
const FamGuides = () => (
  <Layout
    title="FAM Guides"
    description="Help families feel more connected with the FAM Plan, a plan that's actually theirs. A coaching practice with a platform underneath: four specialty paths, a recurring revenue model, and the platform handles billing, scheduling, and family matching while you handle the coaching."
